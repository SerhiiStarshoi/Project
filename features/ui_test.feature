...
Feature: UI Test
  ...
  Scenario: Add new Watch Officer user
    ...
    And I fill in data:
      ...
      | Serhii     | Starshoi  | 13112312fvev@gmail.com | Watch Officer |
    And I click "Save" button
    And I search for user
      | Email                  |
      | 13112312fvev@gmail.com |
    Then I check user is created:
      | First Name | Last Name | Email                  | Role       |
      | Serhii     | Starshoi  | 13112312fvev@gmail.com | br_watcher |
  ...
  #5. Add User має працюватиз myteampage а не логін, можна в степі зроьбити через іф-ку
  ...
  #      expect(user_attrs.values.any?(&:nil?)).to be false case/when
  #11 хук на деактивацію щоб відбувався під кожним сценарієм, робив серч по юзер емейл і дивився чи ніл чи ні, якещо не ніл то деактивовуємо далі
